using FinCore.Core.Application.DTOs.Email;
...
namespace FinCore.Infrastructure.Shared.Services
{
    public class EmailService : IEmailService
    {
        ...
        {
            string subject = $"Confirmación de Transacción Saliente - FinCore";
        ...
        {
            string subject = $"Confirmación de Transacción Entrante - FinCore";
            string message = $"Estimado cliente,\n\n" +
        ...
        {
            string subject = $"Confirmación de Pago a Tarjeta de Crédito - FinCore";
            string message = $"Estimado cliente,\n\n" +
        ...
        {
            string subject = $"Confirmación de Pago de Préstamo - FinCore";
            string message = $"Estimado cliente,\n\n" +
