...
using FinCore.Core.Application.Interfaces; // Asegúrate de que este namespace sea correcto
using FinCore.Core.Domain.Common.Enums; // Para Roles enum
using FinCore.Core.Application.ViewModels.HomeAdmin;
