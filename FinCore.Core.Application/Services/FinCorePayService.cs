...
public class FinCorePayService : IFinCorePayService
{
    ...
    public async Task<HermesPayResponse> ProccesFinCorePay(HermesPayRequest request, ClaimsPrincipal user)
    {
