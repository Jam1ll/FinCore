...
namespace FinCore.Core.Application.Services
{
    public class CashAdvanceService : ICashAdvanceService
    {
        ...
        public async Task<CashAdvanceViewModel> ProcessCashAdvanceAsync(CashAdvanceDTO dto)
        {
            ...
            bool isApproved = dto.Amount <= availableCredit;
            ...
            var savingsTransaction = new Transaction
            {
                ...
                TransactionType = TransactionType.AVANCE,
            ...
            // Si fue aprobado, aplicar cambios a balances
            destinationAccount.Balance += dto.Amount;
            sourceCard.TotalOwedAmount += totalDebtIncrease;
            ...
            if (user != null)
            {
                ...
                <p>Se ha {(isApproved ? "realizado" : "intentado")} un avance de efectivo desde su tarjeta de crédito.</p>
