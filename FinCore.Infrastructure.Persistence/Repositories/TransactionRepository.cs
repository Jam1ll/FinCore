...
namespace FinCore.Infrastructure.Persistence.Repositories
{
    public class TransactionRepository : GenericRepository<Transaction>, ITransactionRepository
    {
        ...
        public TransactionRepository(FinCoreContext context) : base(context)
        {
            _context = context;
        }
        ...
        public async Task<List<Transaction>> GetByConditionAsyncForFinCorePay(Expression<Func<Transaction, bool>> predicate)
        {
            return await _context.Transactions
                                 .Where(predicate)
                                 .ToListAsync();
